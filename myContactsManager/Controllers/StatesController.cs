...
namespace myContactsManager.Controllers
{
    ...
    public class StatesController : Controller
    {
        ...
        public StatesController(MyContactDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Abbrevation")] States states)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Abbrevation")] States states)
        {
            if (id != states.Id)
            {
                return NotFound();
